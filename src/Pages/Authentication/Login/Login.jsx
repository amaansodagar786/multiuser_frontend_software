...
import { FiMail, FiLock, FiEye, FiEyeOff, FiChevronDown, FiHome } from "react-icons/fi";
...
const Login = () => {
  ...
  const formik = useFormik({
    initialValues: { email: "", password: "", storeId: "store1" },
    ...
    onSubmit: async (values) => {
      try {
        ...
        console.log("FRONTEND STORE ID:", values.storeId); // debug
        ...
        localStorage.setItem("storeId", values.storeId);
